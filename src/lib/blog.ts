...
export const posts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "## What I Learned",
      "Building for a real business with real users (147+ reviews on JustDial) taught me things no classroom project could. Performance matters when your users are on 3G connections. Trust indicators (BIS hallmark badges, transparent pricing breakdowns) matter more than flashy animations. And the best technology is invisible, my uncle doesn't need to know about Prisma or SDXL, he just needs to upload a photo and have it appear on the website looking great.",
  ...
  },
  {
    ...
    content: [
      ...
      "This constraint made me a better engineer. I obsess over performance (our customers are often on slow connections), I write interfaces that are obvious (the admin dashboard uses Hindi labels), and I never add complexity that doesn't serve a real user need.",
