  ...
  useEffect(() => {
    ...
    function draw(time: number) {
      ...
      for (const edge of edges) {
        ...
        grad.addColorStop(0, `rgba(237,230,213,${alpha})`);
        grad.addColorStop(0.5, `rgba(237,230,213,${alpha * 0.7})`);
        grad.addColorStop(1, `rgba(237,230,213,${alpha})`);
      ...
      for (let i = 0; i < nodes.length; i++) {
        ...
        glow.addColorStop(0, `rgba(237,230,213,${totalOpacity * 0.22})`);
        glow.addColorStop(0.4, `rgba(237,230,213,${totalOpacity * 0.08})`);
        ...
        ctx!.beginPath();
        ctx!.fillStyle = `rgba(237,230,213,${totalOpacity})`;
        ctx!.arc(p.px, p.py, r, 0, Math.PI * 2);
        ctx!.fill();

        if (n.type === "gem" && extra > 0.3) {
          ctx!.beginPath();
          ctx!.fillStyle = `rgba(250,245,232,${extra * 0.6})`;
